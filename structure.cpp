...
void print_data() {
	...
	cout << "This is your data and its saved even if you want to quit, do you want to quit, write 'yes'?" << endl;
	...
	if(choice == "yes")
	{
		cout << "your data is saved at holiday_plans.txt and will continue to be saved";
